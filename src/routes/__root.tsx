...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://orvexdex.lovable.app/og-cover.jpg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "640" },
      { property: "og:image:alt", content: "ORVEX — The Connoisseur's DEX on LitVM" },
      { name: "twitter:image", content: "https://orvexdex.lovable.app/og-cover.jpg" },
